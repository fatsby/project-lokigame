...
import com.theliems.lokigame.infrastructure.exception.ResourceNotFoundException;
...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        Player player = Player.builder()
                ...
                .role(Role.ROLE_USER)
                .currency(1000L) // Starting currency
                .build();

        player = playerRepository.save(player);

        String accessToken = tokenProvider.generateToken(player.getPlayerId(), player.getUsername(), player.getRole().name());
    ...
    public TokenPair refreshToken(String refreshToken) {
        ...
        String newAccessToken = tokenProvider.generateToken(player.getPlayerId(), player.getUsername(), player.getRole().name());
